...
from app.model_loader import get_artifacts, ArtifactMismatchError, ModelLoadError, ModelDiscoveryError
...
LOAD_ERRORS = (FileNotFoundError, ArtifactMismatchError, ModelLoadError, ModelDiscoveryError)
